...
To keep predictions within a meaningful range ArviZ limits the predictive data relative to the maximum observed duration, preventing the survival curves from extending too far beyond the observed data. You can change this with the argument `extrapolation_factor`, which defaults to 1.2, meaning up to a 20% larger that the maximum observation.
